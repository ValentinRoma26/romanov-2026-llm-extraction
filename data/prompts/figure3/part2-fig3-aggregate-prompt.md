...
Provide the full prompt first. If you have any questions, ask them at the end, second. Unless the request is very specific, unambiguous and easy to execute, always ask follow up questions to get more context from me
{/initial prompt}